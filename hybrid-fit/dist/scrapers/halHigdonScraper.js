...
exports.scrapeHalHigdonPlanLinks = scrapeHalHigdonPlanLinks;
exports.scrapeHalHigdonPlan = scrapeHalHigdonPlan;
exports.scrapeAllHalHigdonPlans = scrapeAllHalHigdonPlans;
...
const jsonPathPlans = path_1.default.resolve(__dirname, "./scraped-json/halHigdonTrainingPlans.json");
const jsonPathTemplates = path_1.default.resolve(__dirname, "./scraped-json/halHigdonWorkoutTemplates.json");
// Parse workout text and create a unique workout template ID
function parseWorkoutToTemplateId(workoutText) {
...
function createWorkoutTemplate(workoutText) {
    const normalized = workoutText.toLowerCase().trim();
...
async function scrapeHalHigdonPlanLinks() {
...
async function scrapeHalHigdonPlan(planUrl, planName, level, raceType) {
    try {
        const { data } = await axios_1.default.get(planUrl);
...
async function scrapeAllHalHigdonPlans() {
    ...
    // Save to JSON
    await (0, saveDataAsJson_1.saveHalHigdonPlans)(allPlans, allTemplates);
